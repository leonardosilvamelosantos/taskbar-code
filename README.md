...
A floating Windows widget that shows, in real time, what each
[Claude Code](https://claude.com/claude-code) session is doing — anchored near
the taskbar, always on top, with a carousel between terminals when more than
